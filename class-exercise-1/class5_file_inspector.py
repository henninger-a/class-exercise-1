...
def main():
    ...
    try:
        inspect_extension(inspect_file(args.input))
    ...
    #         exit with sys.exit(1).
        ...
        logger.error(f"Unsupported format: Unsupported text format: {file_info['Extension']}'")
        sys.exit(1)

    # TODO 5: Log an INFO message containing the
    #         file name and extension.

    logger.info(f'File: {args.input} Extension: {file_info['Extension']}')
